...
const Projects = () => {
  ...
  return (
    <section className="px-3 py-5 md:px-0 md:py-10">
      ...
      <div className="flex flex-wrap justify-center gap-10">
        {t("projects.projects", { returnObjects: true }).map((item) => (
          <div
            className="mb-[30px] inline-block cursor-pointer bg-[#1f1f1f] p-3 text-center shadow-card transition duration-[0.2] ease-linear hover:scale-[1.01] hover:shadow-card-hover "
          ...
          >
            ...
            <p className="font-xl mt-2 font-bold uppercase tracking-wide text-white">
              {item.title}
            </p>
          </div>
        ))}
